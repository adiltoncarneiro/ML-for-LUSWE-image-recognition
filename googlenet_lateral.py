...
path1 = 'C:/Users/m157546/Desktop/flower/lateral/images'    #path of folder of images    
path2 = 'C:/Users/m157546/Desktop/flower/lateral/resized'  #path of folder to save images    
...
model.fit({'input': X}, {'target': Y}, n_epoch=10, validation_set=({'input': X_test}, {'target': Y_test}), shuffle=True,
          ...
          snapshot_epoch=True, run_id='googlenet_lateral')

model.save('googlenet_lateral')
...
np.savetxt('google_lateral.txt',bz)
